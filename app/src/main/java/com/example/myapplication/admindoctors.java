...
public class admindoctors extends AppCompatActivity {
    ...
    public static final String EXTRA_TIME="com.example.myapplication.EXTRA_TIME";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admindoctors);
        Query query=ref.whereEqualTo("hospital",adminhome.ADMIN_HOSPITAL);
        ...
        adapter.setonitemclicklistner(new doctoradapter.ondocclicklistner() {
            ...
            public void onitemclick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent intent=new Intent(admindoctors.this,admindoclook.class);
                ...
                intent.putExtra(EXTRA_TIME,d.getTime());
                finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.backmenu:{
                finish();
                startActivity(new Intent(admindoctors.this,adminhome.class));
